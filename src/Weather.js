  ...
  componentDidMount(){
    ...
    Promise.all([fetch(weather), fetch(forecast)])
      ...
      .catch(error => {
        ...
        const weather = `https://api.openweathermap.org/data/2.5/weather?q=bangalore&APPID=${APIkey}&units=metric`;
    const forecast = `https://api.openweathermap.org/data/2.5/forecast?q=bangalore&APPID=${APIkey}&units=metric`;
    ...
    if(weatherInfo != null){
      return(
        ...
        <div className="weat">
          ...
          <input className="SearchInput" type="text" value={value} placeholder="Search" onChange={this.handleInputChange} />
